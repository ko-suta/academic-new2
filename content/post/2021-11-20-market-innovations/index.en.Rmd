...
data3 <- read_csv(here("content", "post", "2021-11-20-market-innovations", "Timing-Period.csv"), col_names = TRUE)
...
knitr::include_graphics(here("content", "post", "2021-11-20-market-innovations", "Timing2.png"))
```
...
data4 <- read_csv(here("content", "post", "2021-11-20-market-innovations", "Patrat-Period.csv"), col_names = TRUE)
...
knitr::include_graphics(here("content", "post", "2021-11-20-market-innovations", "Patrat2.png"))
```
...
\begin{equation} 
  \log q_{it} = \log \alpha_t + \log \biggl(\beta_1 \frac {R\&D_{it}} {A_{it}} + \beta_2 \frac {Pat_{it}} {R\&D_{it}} + \beta_3 \frac {Cites_{it}} {Pat_{it}}\biggr) + \varepsilon_{it}
  (\#eq:value4)
\end{equation}
...
```{r embed-example, echo=FALSE, include=FALSE}
xaringanExtra::embed_xaringan(
  "https://kovsiannikov.com/slides/sase-2019/sase-2019.html", ratio = "16:9"
)
```
