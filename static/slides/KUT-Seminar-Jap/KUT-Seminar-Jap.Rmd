...
meta() %>%
  ...
  meta_social(
    ...
    url = "https://kovsiannikov.com/slides/kut-seminar-jap/kut-seminar-jap",
...
# .center.black[理由ウ: .light-blue[個人の財産権]の保護 `r fa("arrow-alt-circle-right", fill = "#cc0033")` 世界で最も古い企業]
