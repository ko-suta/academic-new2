---
title: ".yellow[Ukraine] & .red[Japan]: <br> Historical & Cultural Parallels <br> in the Context of Russia's Invasion"
subtitle: ".light-blue[Presentation made at <br> K&#333;chi Medical School]"
...
meta() %>%
  ...
  meta_social(
    ...
    url = "https://kovsiannikov.com/slides/KochiMedSchool/KochiMedSchool",
...
```{r echo=FALSE, include=TRUE, out.width = "200%", fig.align='left', fig.cap = '<a href="https://uk.wikipedia.org/wiki/%D0%A4%D0%B0%D0%B9%D0%BB:%D0%97%D0%B5%D0%BB%D0%B5%D0%BD%D0%B8%D0%B9_%D0%9A%D0%BB%D0%B8%D0%BD_1918.png" style="color:Black;">Image source</a>'}
...
### 👣 accepting evacuees (more than 1000 people already)
...
# Hospitallers Medical Battalion `r fa("hand-holding-medical", fill = "black")`

--

.pull-left[

```{r echo=FALSE, include=TRUE, out.width = "100%", fig.align='center', fig.cap = '<a href="https://www.facebook.com/hospitallers/" style="color:Black;">Image source</a>'}
knitr::include_graphics("assets/img/hosp.jpg")
```
...
- Ukrainian volunteer medical battalion formed in 2014

- provides first aid and evacuates wounded Ukrainian soldiers

- since 2019: holding training on performing first aid

- <a href="https://www.newyorker.com/newsletter/the-daily/on-the-ground-with-a-medical-battalion-in-ukraine">The New Yorker article</a> 

- <a href="https://www.hospitallers.life/">Dedicated website</a> 
...
|                                                                                                |                              |
| <a href="https://kovsiannikov.com/slides/KochiMedSchool/KochiMedSchool">`r fa("link", fill = "#cc0033")` | kovsiannikov.com             |
