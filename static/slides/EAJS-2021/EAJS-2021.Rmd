...
subtitle: "2021 EAJS Conference: <br> .white.bg-black[Econ07: Corporate governance and monetary policy]"
...
BibOptions(check.entries = FALSE,
           ...
           hyperlink = FALSE,
           dashed = FALSE)
myBib <- ReadBib(here("static", "slides", "EAJS-2021", "Innovation.bib"), check = FALSE)
```
...
meta() %>%
  ...
  meta_social(
    ...
    description = paste(
      ...
      "Presented at 2021 EAJS Conference."
    ),
    url = "https://kovsiannikov.com/slides/EAJS-2021/EAJS-2021",
    image = "https://kovsiannikov.com/img/Techno-screen.png",
    image_alt = "2021 EAJS Conference Presentation",
    og_type = "website",
...
data <- read_csv(here("static", "slides", "EAJS-2021", "Data", "Timing.csv"), col_names = TRUE)
```
...
```{r include=FALSE}
datapar <- read_csv(here("static", "slides", "EAJS-2021", "Data", "Patratio-long2.csv"), col_names = TRUE)
```
...
By plugging the market value $V_{it}$ from the first equation into the numerator, we get the following equation:
...
```{r echo = FALSE}
General <- read.csv(here("static", "slides", "EAJS-2021", "Data", "General3.csv"), sep=",", header=TRUE, encoding="UTF-8")
...
cm <- c("(Intercept)" = "Constant", 
  ...
  "InvRDA" = "RD/Assets (x Chemical)", "IndustryElectric:InvRDA" = "RD/Assets x Electric", 
  "IndustryMachinery:InvRDA" = "RD/Assets x Machinery", 
  "IndustryPharm:InvRDA" = "RD/Assets x Pharm", 
  "InvPatRD" = "Patents/RD (x Chemical)", "IndustryElectric:InvPatRD" = "Patents/RD x Electric", 
  "IndustryMachinery:InvPatRD" = "Patents/RD x Machinery", 
  "IndustryPharm:InvPatRD" = "Patents/RD x Pharm",
...
background-image: url(assets/img/EAJS.png)
...
|                                                                                                |                              |
| <a href="https://kovsiannikov.com/slides/eajs-2021/eajs-2021">`r fa("link", fill = "#cc0033")` | kovsiannikov.com             |
