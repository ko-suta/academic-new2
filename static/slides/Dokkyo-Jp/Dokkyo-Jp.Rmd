...
subtitle: ".light-blue[鏡川緑地公園のイベント]"
...
- .blue[日付]: 1986年04月26日 `r fa("circle-right", fill = "#cc0033")` 2011年03月11日

- .blue[原因]: 人的ミス `r fa("circle-right", fill = "#cc0033")`　自然災害

- .blue[放射能]: 14,000 PBq (ベクレル) ~ 空気 `r fa("circle-right", fill = "#cc0033")`  780 PBq ~ 海洋

- .blue[被災地]: 500 km `r fa("circle-right", fill = "#cc0033")` 30 km

- .blue[移動人口]: 335,000 `r fa("circle-right", fill = "#cc0033")` 154,000

- .blue[帰国人口]: なし `r fa("circle-right", fill = "#cc0033")` 122,00
...
.black[福島大学環境放射能研究所] (2013年に設立)  **`r fa("people-carry-box", fill = "green")`**
...
.black[研究内容]: 放射性物質 (.blue[ストロンチウム90] and .blue[セシウム137]) + 汚染水 `r fa("circle-right", fill = "#cc0033")` .black[立入禁止区域]を刷新する
...
- 1991年: ソ連の崩壊 (計画経済 `r fa("circle-right", fill = "#cc0033")` 資本主義)

- 企業: 長期的契約 `r fa("circle-right", fill = "#cc0033")` 短期的契約

- 社会主義 `r fa("circle-right", fill = "#cc0033")` 民主主義
...
- 終身雇用 `r fa("circle-right", fill = "#cc0033")` [一部] 成果主義
...
# .center[`r fa("circle-down", fill = "#cc0033")`] 

--

# .center.black[理由: .light-blue[個人の財産権]の保護 `r fa("circle-right", fill = "#cc0033")` 世界で最も古い企業]

--

# .center.black[.light-blue[しかし], 平和は永遠のことではない `r fa("circle-right", fill = "#cc0033")` 予期せぬ困難に備えることの重要性]
...
### 私の連絡先 `r fa("circle-down", fill = "#cc0033")`
