...
```{r echo=FALSE, include=TRUE, out.width = "75%", fig.align='center', fig.cap = '<a href="https://unsplash.com/photos/gpjGmbPLUxk" style="color:Black;">Image source</a>'}
...
# .center.black[.light-blue[but], peace is not eternal `r fa("arrow-alt-circle-right", fill = "#cc0033")` always be ready to face unexpected challanges!]
