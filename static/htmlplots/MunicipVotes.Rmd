...
```{r turnout-spatial, results='asis'}
...
modelsummary(models_V, add_rows = ar, stars = T, 
             output = "html",
             title = 'Spatial models with fixed and time effects', fmt = 3)
```


## LDP votes (relative)

```{r ldp-spatial, results='asis'}
