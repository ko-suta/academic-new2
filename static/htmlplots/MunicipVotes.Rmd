...
TurnoutMod2 <- plm(Turnout ~ Year + Fstrength + LDP + LATperCapita,
                   index=c("Code","Year"),
                   model = "pooling", data = Elections3)

TurnoutMod3 <- plm(Turnout ~ Year + Fstrength + LDP + LATperCapita +
                   Kaso.fusion*EldPop, index=c("Code","Year"),
                   model = "pooling", data = Elections3)
...
TurnoutMod5 <- plm(Turnout_relative ~ Year + Fstrength + LDP + LATperCapita,
                   index=c("Code","Year"),
                   model = "pooling", data = Elections3)

TurnoutMod6 <- plm(Turnout_relative ~ Year + Fstrength + LDP + 
                   LATperCapita + Kaso.fusion*EldPop, index=c("Code","Year"),
                   model = "pooling", data = Elections3)
...
htmlreg(list(TurnoutMod2, TurnoutMod3,
       ...
       custom.coef.names = c("(Intercept)",
                             ...
                             "Fully depopulating (merged)", "Elderly",
                             "x Quasi-depopulating",
                             "x Partly depopulating", "x Fully depopulating",
                             "x Fully depopulating (merged)"
                             ),
  ...
  groups = list("Year dummy (base group = '2012')" = 2:4,
                     ...
                     "Elderly (base group = 'x Normal')" = 13:16),
       caption = NULL,
       digits = 2,
...
LDPMod2 <- plm(LDP ~ Year + Fstrength + Turnout + LATperCapita, index=c("Code","Year"),
                   model = "pooling", data = Elections3)

LDPMod3 <- plm(LDP ~ Year + Fstrength + Turnout + 
                   LATperCapita + Kaso.fusion*EldPop, index=c("Code","Year"),
                   model = "pooling", data = Elections3)
...
LDPMod5 <- plm(LDP_relative ~ Year + Fstrength + Turnout + 
                 LATperCapita, index=c("Code","Year"),
               model = "pooling", data = Elections3)

LDPMod6 <- plm(LDP_relative ~ Year + Fstrength + Turnout + 
                   LATperCapita + Kaso.fusion*EldPop, index=c("Code","Year"),
                   model = "pooling", data = Elections3)
...
LDPDifMod2 <- plm(LDPDif ~ Year + Fstrength + Turnout +
                    LATperCapita, index=c("Code","Year"),
                   model = "pooling", data = Elections3)

LDPDifMod3 <- plm(LDPDif ~ Year + Fstrength + Turnout + 
                   LATperCapita + Kaso.fusion*EldPop, index=c("Code","Year"),
                   model = "pooling", data = Elections3)
...
LDPDifMod5 <- plm(LDPDif_relative ~ Year + Fstrength + Turnout +
                    LATperCapita, index=c("Code","Year"),
                   model = "pooling", data = Elections3)

LDPDifMod6 <- plm(LDPDif_relative ~ Year + Fstrength + Turnout + 
                   LATperCapita + Kaso.fusion*EldPop, index=c("Code","Year"),
                   model = "pooling", data = Elections3)
...
```{r include=FALSE}
fm_turnout <- Turnout ~ Fstrength + EldPop + LDP + Kaso.fusion
fm_turnout_rel <- Turnout_relative ~ Fstrength + EldPop + LDP + Kaso.fusion

fm_LDP <- LDP ~ Fstrength + EldPop + Turnout + Kaso.fusion
fm_LDP_rel <- LDP_relative ~ Fstrength + EldPop + Turnout + Kaso.fusion
```
...
rows <- tribble(~term, ~`Spatial Lag`,  ~`Spatial Error`, ~`Lag + Error`, ~`Spatial Lag`,  ~`Spatial Error`, ~`Lag + Error`,
...
modelsummary(list("Spatial Lag" = sp_lag_turnout_2021,
  ...
  pack_rows("Fiscal type (base group = ‘Normal’)", 9, 15) %>%
  row_spec(17, background = 'lightblue') %>%
...
tbl_sp_panel <- as.data.frame(cbind(sp_lag_turnout_sum$CoefTable[c(2:11,1), c(1, 2, 4)],
                                    sp_er_turnout_sum$CoefTable[c(2:11,1), c(1, 2, 4)],
                                    sarar_turnout_sum$CoefTable[c(3:12,2), c(1, 2, 4)]))
...
tbl_sp_panel <- as.data.frame(cbind(sp_lag_turnout_rel_sum$CoefTable[c(2:11,1), c(1, 2, 4)],
                                    sp_er_turnout_rel_sum$CoefTable[c(2:11,1), c(1, 2, 4)],
                                    sarar_turnout_rel_sum$CoefTable[c(3:12,2), c(1, 2, 4)]))
...
modelsummary(list("Spatial Lag" = mod_grp_V,
  ...
  pack_rows("Fiscal type (base group = ‘Normal’)", 13, 19) %>%
...
tbl_sp_panel_LDP <- as.data.frame(cbind(sp_lag_LDP_sum$CoefTable[c(2:11,1), c(1, 2, 4)],
                                    sp_er_LDP_sum$CoefTable[c(2:11,1), c(1, 2, 4)],
                                    sarar_LDP_sum$CoefTable[c(3:12,2), c(1, 2, 4)]))
...
tbl_sp_panel_LDP <- as.data.frame(cbind(sp_lag_LDP_rel_sum$CoefTable[c(2:11,1), c(1, 2, 4)],
                                    sp_er_LDP_rel_sum$CoefTable[c(2:11,1), c(1, 2, 4)],
                                    sarar_LDP_rel_sum$CoefTable[c(3:12,2), c(1, 2, 4)]))
