...
htmlreg(list(TurnoutMod1, TurnoutMod2, TurnoutMod3,
  TurnoutMod4, TurnoutMod5, TurnoutMod6),
       custom.model.names = c("Model 1", "Model 2", "Model 3",
                              "Model 4", "Model 5", "Model 6"),
       custom.coef.names = c("(Intercept)",
                             "2014", "2017", "2021", "Fiscal Strength",
                             "Elderly", "LDP", "Quasi-depopulating",
                             "Partly depopulating", "Fully depopulating", "Fully depopulating (merged)"),
  custom.header = list("Turnout" = 1:3, "Turnout (relative)" = 4:6),
...
htmlreg(list(LDPMod1, LDPMod2, LDPMod3,
             LDPMod4, LDPMod5, LDPMod6),
       custom.model.names = c("Model 1", "Model 2", "Model 3",
                              "Model 4", "Model 5", "Model 6"),
       custom.coef.names = c("(Intercept)", 
                             "2014", "2017", "2021", "Fiscal Strength",
                             "Elderly", "Turnout", "Quasi-depopulating",
                             "Partly depopulating", "Fully depopulating", "Fully depopulating (merged)"),
       custom.header = list("LDP" = 1:3, "LDP (relative)" = 4:6),
       groups = list("Year dummy (base group = '2012')" = 2:4,
         "Fiscal type (base group = 'Normal')" = 8:11),
       caption = NULL,
       digits = 2,
...
htmlreg(list(LDPDifMod1, LDPDifMod2, LDPDifMod3,
  LDPDifMod4, LDPDifMod5, LDPDifMod6),
       custom.model.names = c("Model 1", "Model 2", "Model 3",
                              "Model 4", "Model 5", "Model 6"),
       custom.coef.names = c("(Intercept)",
                             "2014", "2017", "2021", "Fiscal Strength",
